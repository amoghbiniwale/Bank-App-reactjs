              ...
              <div className="col">
                ...
                <form>
                  <div class="form-outline mb-4">
                    ...
                    />
                    <label class="form-label" for="form5Example1" style={{color:"brown"}}>
                  ...
                  <div class="form-outline mb-4">
                    ...
                    />
                    <label class="form-label" for="form5Example2" style={{color:"brown"}}>
                  ...
                  <div class="col-12">
                    <label class="visually-hidden" for="inlineFormSelectPref" style={{color:"brown"}}>
                      Transaction Types
                    </label>
                    <select
                      class="select"
